return {
    ...
    keys = {
        ...
        { "<leader>sj", ":SuiteQL EditTableUnderCursor<cr>",     desc = "Edit the table under the cursor in browser" },
        { "<leader>su", ":SuiteQL ListTableUnderCursor<cr>",     desc = "List the table under the cursor in browser" },
    },
    opts = {
        sqlFormatter = {
            keywordCase = "upper",
